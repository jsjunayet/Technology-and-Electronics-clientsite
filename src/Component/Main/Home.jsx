        ...
        <div className='h-[550px]'>
            <>
                ...
                >
                    ...
                    ></div>
                    <SwiperSlide className='lg:mt-20 mt-1'>
                        ...
                        <div className="text" data-swiper-parallax="-100">
                            <p className='px-1 lg:px-20 lg:text-xl text-sm'>
                    ...
                    <SwiperSlide className='lg:mt-16 mt-1'>
                        <div className="lg:text-5xl lg:text-bold text-2xl font-semibold text-center" data-swiper-parallax="-300">
                            Technology and Electronics
                        </div>
                        <div className="subtitle text-4xl font-semibold" data-swiper-parallax="-200">
                    ...
                    <SwiperSlide className='lg:text-5xl lg:text-bold text-2xl lg:mt-10 font-semibold text-center'>
                        <div className="lg:text-5xl text-2xl" data-swiper-parallax="-300">
                            Technology and Electronics
                        </div>
                        <div className="subtitle text-4xl font-semibold" data-swiper-parallax="-200">
                            Google
